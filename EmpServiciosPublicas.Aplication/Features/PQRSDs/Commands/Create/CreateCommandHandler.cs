...
namespace EmpServiciosPublicas.Aplication.Features.PQRSDs.Commands.Create
{
    public class CreateCommandHandler : IRequestHandler<CreateCommand, string>
    {
        ...
        public CreateCommandHandler(IMapper mapper, ILogger<CreateCommand> logger, IEmailService emailService, IUnitOfWork unitOfWork, IUploadFilesService uploadFilesService, IOptions<StorageSetting> storageSetting)
        {
            _mapper = mapper;
            _logger = logger;
