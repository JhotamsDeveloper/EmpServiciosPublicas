...
namespace EmpServiciosPublicas.Aplication.Features.PQRSDs.Commands.Update
{
    public class UpdateCommandHandler : IRequestHandler<UpdateCommand>
    {
        ...
        public UpdateCommandHandler(IMapper mapper, ILogger<UpdateAnonymousCommandHandler> logger, IUnitOfWork unitOfWork, IUploadFilesService uploadFilesService, IOptions<StorageSetting> storageSetting)
        {
            _mapper = mapper;
            _logger = logger;
